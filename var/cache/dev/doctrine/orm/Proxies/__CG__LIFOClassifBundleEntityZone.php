 ...
 */
class Zone extends \LIFO\ClassifBundle\Entity\Zone implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'LIFO\\ClassifBundle\\Entity\\Zone' . "\0" . 'id', '' . "\0" . 'LIFO\\ClassifBundle\\Entity\\Zone' . "\0" . 'numero', '' . "\0" . 'LIFO\\ClassifBundle\\Entity\\Zone' . "\0" . 'site'];
        }
