 ...
 */
class Numerisation extends \LIFO\ClassifBundle\Entity\Numerisation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'LIFO\\ClassifBundle\\Entity\\Numerisation' . "\0" . 'id', '' . "\0" . 'LIFO\\ClassifBundle\\Entity\\Numerisation' . "\0" . 'extension', '' . "\0" . 'LIFO\\ClassifBundle\\Entity\\Numerisation' . "\0" . 'alt', '' . "\0" . 'LIFO\\ClassifBundle\\Entity\\Numerisation' . "\0" . 'file', '' . "\0" . 'LIFO\\ClassifBundle\\Entity\\Numerisation' . "\0" . 'tempFilename', '' . "\0" . 'LIFO\\ClassifBundle\\Entity\\Numerisation' . "\0" . 'tesson', '' . "\0" . 'LIFO\\ClassifBundle\\Entity\\Numerisation' . "\0" . 'typeNumerisation'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Numerisation $proxy) {
    ...
    public function setTypeNumerisation(\LIFO\ClassifBundle\Entity\TypeNumerisation $typeNumerisation)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTypeNumerisation', [$typeNumerisation]);

        return parent::setTypeNumerisation($typeNumerisation);
    }
    ...
    public function getTypeNumerisation()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTypeNumerisation', []);

        return parent::getTypeNumerisation();
    }
