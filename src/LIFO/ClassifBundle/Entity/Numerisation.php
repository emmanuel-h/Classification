...
class Numerisation {
	...
	public function upload() {
		...
		$this->file->move ( $this->getUploadRootDir (), // Le r�pertoire de destination
							"t" . $this->tesson->getId () . "-n" . $this->id . '.' . $this->extension ); // Le nom du fichier � cr�er, ici � id.extension �
